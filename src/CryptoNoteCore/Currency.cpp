...
bool Currency::generateGenesisBlock() {
  ...
  // Hard code coinbase tx in genesis block. LeviarCoin original Genesis
  std::string genesisCoinbaseTxHex = "013c01ff000180c092928d96b801029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210104bbb5fb59c2c9c7f474ba938323e1ebc0c1dcd4216769e2626b9f7638a784e2";
  ...
  // Original LeviarCoin Genesis nonce
  //genesisBlockTemplate.nonce = 0;
...
bool Currency::getBlockReward(uint32_t height, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
  ...
  uint64_t baseReward;
  if (alreadyGeneratedCoins <= parameters::GENESIS_BLOCK_REWARD) {
    baseReward = parameters::GENESIS_BLOCK_REWARD;
  } else {
